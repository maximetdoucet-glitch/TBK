      ...
      <div className="container mx-auto max-w-[1300px] px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div>
               <Button className="bg-[#f5a623] hover:bg-[#e67e22] text-white rounded-lg h-11 sm:h-14 px-8 sm:px-12 font-semibold text-sm transition-colors">
                  Neem contact op
               </Button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-5 lg:pl-16 lg:border-l border-white/10">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
               ...
               />
               <Button className="bg-[#f5a623] hover:bg-[#e67e22] text-white rounded-lg h-11 sm:h-14 px-8 font-semibold text-sm flex-shrink-0 transition-colors">
                  Abonneer
               </Button>
            </div>
          </div>
