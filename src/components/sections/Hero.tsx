  ...
  return (
    <section className="bg-white py-12">
      <div className="container mx-auto max-w-[1300px] px-4">
        {/* Haddock's Logic: Aspect Ratio 2048x540 (3.79:1) */}
        <div className="relative bg-[#111] overflow-hidden group aspect-[2048/540] border border-gray-100 shadow-xl">
          {/* Background Image - Cinematic, No Cigar, Wide Aspect */}
          <div className="absolute inset-0 z-0">
             <Image 
                ...
                priority
             />
             {/* Subtle gradient on the left half to ensure text pops */}
          ...
          <div className="relative z-10 h-full flex flex-col justify-center p-8 md:p-20 text-white max-w-2xl">
             ...
             <h2 className="font-montserrat text-3xl md:text-5xl font-black tracking-tighter leading-[0.95] mb-6">
                1400+ VERSCHILLENDE <br />
                ZIPPO AANSTEKERS
             </h2>
             <p className="text-white/80 text-xs md:text-base font-bold uppercase tracking-[0.2em] mb-10 max-w-md italic">
