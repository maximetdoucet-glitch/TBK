  ...
  return (
    <header className={cn("w-full bg-white sticky top-0 z-50 transition-shadow duration-300", scrolled ? "shadow-md" : "shadow-sm")}>
      ...
      <div className={cn(
        ...
        {/* Logo */}
        <Link href="/preview" className="flex flex-col items-center shrink-0">
          <span className="font-montserrat text-[28px] font-black tracking-[0.08em] text-[#2b3e51] leading-none uppercase">
            TBK
          </span>
          <span className="font-montserrat text-[9px] font-bold tracking-[0.45em] text-[#2b3e51]/60 mt-0.5 uppercase">
            LIGHTSHOP
          </span>
        </Link>
      ...
      <nav className={cn("w-full bg-[#2b3e51] text-white relative transition-all duration-300", scrolled ? "h-0 overflow-hidden" : "overflow-visible")}>
        <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center h-11">
          ...
          <button
            ...
            className={cn(
              ...
              megaOpen ? "bg-[#f39c12]" : "bg-[#f39c12] hover:bg-[#e0890d]"
            )}
          >
            ...
            {NAV_ITEMS.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  item.accent
                    ? "text-[#f39c12] hover:text-[#f39c12]/80"
          ...
          <div className="hidden md:flex items-center gap-2 ml-auto text-[10px] font-bold tracking-widest">
            <div className="flex text-[#f39c12] gap-px">
        ...
        {megaOpen && (
          <div
            ref={megaRef}
            className="absolute top-full left-0 right-0 bg-white text-[#2b3e51] shadow-2xl z-50 border-t-2 border-[#f39c12]"
          >
