          ...
          <div className="flex flex-col gap-6 pr-10 py-16">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={text} className="flex items-center gap-3 text-[12px] text-white/40 hover:text-white/70 transition-colors">
                  <Icon className="size-3.5 text-[#f39c12] shrink-0" />
                  {text}
                </li>
              ))}
            </ul>
            <div className="flex gap-2 pt-1">
              {[
                ...
                <Link key={label} href="#" aria-label={label} className="size-9 rounded-lg border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-[#f39c12] hover:bg-[#f39c12]/10 transition-all">
                  {svg}
                </Link>
              ))}
            </div>
