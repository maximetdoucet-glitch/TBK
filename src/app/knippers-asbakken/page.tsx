...
const SUB_FILTERS = [
  { key: "knippers", label: "Sigarenknippers", match: (n: string) => /knipper|cutter/i.test(n) },
  { key: "etuis",    label: "Sigaren-etuis",   match: (n: string) => /sigarenetui|sigaren-etui|cigar.*case/i.test(n) },
  { key: "asbakken", label: "Sigaren-asbakken",match: (n: string) => /asbak|ashtray/i.test(n) },
  { key: "humidors", label: "Humidors",        match: (n: string) => /humidor/i.test(n) },
] as const;
