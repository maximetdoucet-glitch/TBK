...
const PER_PAGE = 24;
const COLLECTION_NAME = "Kokers & Etuis";
const COLLECTION_SLUG = "/kokers-etuis";
const COLLECTION_TAGLINE = "70 producten · Grootste tabakspecialist van Nijmegen";
...
export default async function KokersEtuisPage({
  searchParams,
}: {
