          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 xl:gap-24">
            ...
            <div className="flex flex-col gap-3">
              <div className="relative bg-[#f8f8f8] aspect-square overflow-hidden flex items-center justify-center p-6 sm:p-12 rounded-sm">
                ...
                />
                {product.badge && (
                  <span className="absolute top-5 left-5 bg-[#f39c12] text-white text-[10px] font-medium px-2.5 py-1 rounded-sm">
                    {product.badge}
                  </span>
                )}
                {discount && (
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="flex gap-0.5">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className={`size-4 fill-current ${i < product.rating ? "text-[#f39c12]" : "text-gray-200"}`}
                    />
                  ))}
                </div>
              ...
              <div className="flex items-baseline gap-3 mb-7 pb-7 border-b border-gray-100">
                ...
                {product.oldPrice && (
                  <>
                    ...
                    <span className="text-xs font-semibold bg-[#f39c12]/10 text-[#f39c12] px-2 py-0.5 rounded">
                      −{discount}%
                    </span>
                  </>
                )}
