        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/aanstekers">
              <Button className="bg-[#f9c76b] hover:bg-[#6b8e6b] rounded-sm text-sm px-8 h-11">
        ...
        <div className="container mx-auto max-w-[1300px] px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 xl:gap-24">
            ...
            <div className="flex flex-col gap-3">
              <div className="relative bg-[#f8f8f8] aspect-square overflow-hidden flex items-center justify-center p-6 sm:p-12 rounded-sm">
                ...
                />
                {product.badge && (
                  <span className="absolute top-5 left-5 bg-[#f9c76b] text-white text-[10px] font-medium px-2.5 py-1 rounded-sm">
                    {product.badge}
                  </span>
                )}
                {discount && (
            ...
            <div className="flex flex-col">
              {/* Brand */}
              <p className="text-xs text-[#f9c76b] font-medium mb-2">{product.brand}</p>
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="flex gap-0.5">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className={`size-4 fill-current ${i < product.rating ? "text-[#f9c76b]" : "text-gray-200"}`}
                    />
                  ))}
                </div>
              ...
              <div className="flex items-baseline gap-3 mb-7 pb-7 border-b border-gray-100">
                ...
                {product.oldPrice && (
                  <>
                    ...
                    <span className="text-xs font-semibold bg-[#f9c76b]/10 text-[#f9c76b] px-2 py-0.5 rounded">
                      −{discount}%
                    </span>
                  </>
                )}
              ...
              <div className="flex flex-col gap-2.5 py-5 border-t border-b border-gray-100 mb-7">
                {[
                  ...
                  <div key={item} className="flex items-center gap-2.5">
                    <Check className="size-3.5 text-[#f9c76b] shrink-0" />
          ...
          <div className="mt-12 lg:mt-20 pt-10 lg:pt-12 border-t border-gray-100">
            <div className="flex justify-between items-center mb-8">
              ...
              <Link
                href="/aanstekers"
                className="flex items-center gap-1.5 text-xs text-[#f9c76b] hover:text-[#2b3e51] transition-colors"
              >
              ...
              {PRODUCTS.filter((p) => p.id !== product.id)
                ...
                .map((related) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      <p className="text-[10px] text-[#f9c76b] font-medium mb-1">{related.brand}</p>
